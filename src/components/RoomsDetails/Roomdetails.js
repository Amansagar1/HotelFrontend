...
//                     <div className="relative w-full md:w-1/2 bg-gray-100 rounded-lg ">
//                         <Image
//                             src={room.image || images[currentImageIndex]}
//                             alt={`Room Image ${currentImageIndex + 1}`}
//                             className="object-cover w-full h-full"
//                             width={500}
//                             height={500}
...
// Define hardcoded images for each room type
const roomImages = {
    "Deluxe Room": [
        "/images/rooms/deluxeroom.jpg",
        "/images/rooms/bedroombackview.jpg",
        "/images/rooms/bedroomfront.jpg",
        "/images/rooms/washroomhandwash.jpeg",
        "/images/rooms/washroom.jpeg",
    ],
    "Super Deluxe Room": [
        "/images/rooms/superdeluxeroom1.jpg",
        "/images/rooms/superdeluxeroom.jpg",
        "/images/rooms/superdeluxebedfront.jpg",
        "/images/rooms/washroomhandwash.jpeg",
        "/images/rooms/washroom.jpeg",
    ],
    "Family Room": [
        "/images/rooms/familyroom.jpg",
        "/images/rooms/familybedroomleftview.jpg",
        "/images/rooms/familyroomwithtv.jpg",
        "/images/rooms/washroomhandwash.jpeg",
        "/images/rooms/washroom.jpeg",
    ],
    // Add more room types and images as needed
};
...
const RoomDetailsPopup = ({ isVisible, onClose, room }) => {
    ...
    // Get the images for the current room based on the room type
    const images = roomImages[room.name] || ["/images/default-room.jpg"]; // Fallback to a default room image
